    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          propertyType: {
            type: 'string',
            enum: ['APARTMENT', 'HOUSE', 'STUDIO', 'ROOM', 'PENTHOUSE', 'DUPLEX', 'LOFT', 'OTHER'],
          ...
          heatingType: {
            type: 'string',
            enum: ['GAS', 'ELECTRIC', 'CENTRAL', 'INDIVIDUAL', 'NONE'],
          },
          ...
          // Onboarding fields
          addressRaw: { type: 'string', description: 'Flat address string for display' },
          hasElevator: { type: 'boolean' },
          outdoorFeatures: {
            type: 'array',
            items: { type: 'string' },
            description: 'e.g. terrace, balcony',
          },
          overallCondition: { type: 'string', enum: ['NEW', 'GOOD', 'SATISFACTORY', 'NEEDS_WORK'] },
          buildingYear: {
            type: 'integer',
            minimum: 1800,
          ...
          kitchenAppliances: {
            type: 'array',
            items: { type: 'string' },
            description: 'e.g. fridge, stove_electric',
          },
          washingFacilities: {
            type: 'array',
            items: { type: 'string' },
            description: 'e.g. washing_machine, tumble_dryer',
          },
          bathroomFeatures: {
            type: 'array',
            items: { type: 'string' },
            description: 'e.g. shower, bathtub',
          },
          hotWaterSystems: {
            type: 'array',
            items: { type: 'string' },
            description: 'e.g. gas_boiler, electric_boiler',
          },
          airConditioningTypes: {
            type: 'array',
            items: { type: 'string' },
            description: 'e.g. central_ac, split_units',
          },
          otherAmenities: {
            type: 'array',
            items: { type: 'string' },
            description: 'e.g. fireplace, pool',
          },
          parkingOptions: {
            type: 'array',
            items: { type: 'string' },
            description: 'e.g. parking_included, street_parking',
          },
          electricityIncluded: { type: 'boolean' },
          waterIncluded: { type: 'boolean' },
          gasIncluded: { type: 'boolean' },
          petsAllowed: { type: 'string', enum: ['YES', 'NO', 'NEGOTIABLE'] },
          kidsAllowed: { type: 'string', enum: ['YES', 'NO', 'NEGOTIABLE'] },
          smokingAllowed: { type: 'string', enum: ['YES', 'NO'] },
          maxTenants: { type: 'integer', minimum: 1 },
          moveInOption: { type: 'string', description: 'e.g. asap, choose_date' },
          moveInDate: { type: 'string', description: 'ISO date string' },
          moveOutOption: { type: 'string', description: 'e.g. until_further_notice, choose_date' },
          moveOutDate: { type: 'string', description: 'ISO date string' },
        },
        examples: [
          {
            address: {
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          cadastralNumber: { type: 'string' },
          // Onboarding fields
          addressRaw: { type: 'string' },
          hasElevator: { type: 'boolean' },
          outdoorFeatures: { type: 'array', items: { type: 'string' } },
          overallCondition: { type: 'string', enum: ['NEW', 'GOOD', 'SATISFACTORY', 'NEEDS_WORK'] },
          buildingYear: { type: 'integer', minimum: 1800 },
          energyClass: { type: 'string', enum: ['A', 'B', 'C', 'D', 'E', 'F', 'G'] },
          kitchenAppliances: { type: 'array', items: { type: 'string' } },
          washingFacilities: { type: 'array', items: { type: 'string' } },
          bathroomFeatures: { type: 'array', items: { type: 'string' } },
          hotWaterSystems: { type: 'array', items: { type: 'string' } },
          airConditioningTypes: { type: 'array', items: { type: 'string' } },
          otherAmenities: { type: 'array', items: { type: 'string' } },
          parkingOptions: { type: 'array', items: { type: 'string' } },
          electricityIncluded: { type: 'boolean' },
          waterIncluded: { type: 'boolean' },
          gasIncluded: { type: 'boolean' },
          petsAllowed: { type: 'string', enum: ['YES', 'NO', 'NEGOTIABLE'] },
          ...
          smokingAllowed: { type: 'string', enum: ['YES', 'NO'] },
          maxTenants: { type: 'integer', minimum: 1 },
          moveInOption: { type: 'string' },
          moveInDate: { type: 'string' },
          moveOutOption: { type: 'string' },
          moveOutDate: { type: 'string' },
        },
        examples: [
          {
            kitchenAppliances: ['fridge', 'stove_electric', 'dishwasher'],
            washingFacilities: ['washing_machine'],
